...
int CameraPlatform_StartCapture(dmBuffer::HBuffer* buffer, CameraType type, CameraInfo& outparams)
{
	...
	CMVideoDimensions dimensions = _CameraPlatform_GetSize(type == CAMERA_TYPE_BACK ? AVCaptureDevicePositionBack : AVCaptureDevicePositionFront);
	...
	[g_Camera.m_Delegate startCamera];
